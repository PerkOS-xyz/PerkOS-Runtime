...
/** Display order: PerkOS LLM when the wallet has it, then subscriptions and keys, a local runner last. */
const RANK: Record<string, number> = { perkos: -1, xai: 0, openai: 1, anthropic: 2, local: 9 };
